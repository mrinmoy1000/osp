...
public class OspProfessionalBean implements Serializable {
  ...
  private List<OspProfPublication> lstProfPublication;
  private List<OspProfPresentation> lstProfPresentation;
...
/**
  ...
  /**
   * @return the lstProfPublication
   */
  public List<OspProfPublication> getLstProfPublication() {
    return lstProfPublication;
  }

  /**
   * @param lstProfPublication the lstProfPublication to set
   */
  public void setLstProfPublication(List<OspProfPublication> lstProfPublication) {
    this.lstProfPublication = lstProfPublication;
  }

  /**
   * @return the lstProfPresentation
   */
  public List<OspProfPresentation> getLstProfPresentation() {
    return lstProfPresentation;
  }

  /**
   * @param lstProfPresentation the lstProfPresentation to set
   */
  public void setLstProfPresentation(List<OspProfPresentation> lstProfPresentation) {
    this.lstProfPresentation = lstProfPresentation;
  }
  ...
  /**
   * @param acheivements the acheivements to set
   */
  ...
  /**
   * @param registeredMemNos the registeredMemNos to set
   */
