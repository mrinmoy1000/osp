...
public class AppConstants {
  ...
  public static String PROFESSIONAL_FETCH_PROFILE_MODULE = "PROFESSIONAL_DATARETRIVAL_MODULE";
  public static String PROFESSIONAL_FETCH_PROFILE_MODULE_EXCEPTION_ERRCODE = "PROFESSIONAL 002";
  public static String PROFESSIONAL_FETCH_PROFILE_MODULE_EXCEPTION_ERRDESC = "Professional Fetch Failed";
