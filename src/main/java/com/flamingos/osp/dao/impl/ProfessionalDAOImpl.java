...
public class ProfessionalDAOImpl implements ProfessionalDAO {
	...
	public void emailUpdateStatus(UserBean user, AccessToken access) throws OspDaoException {
		...
		try {
			String updateEmailStatusSql = " UPDATE OSP_ACCESS_TOKEN acc , OSP_USER_CREDENTIAL up " + "  SET " + " up."
					...
					+ AppConstants.LOGIN_TS + " = :" + AppConstants.LOGIN_TS + " , acc." + AppConstants.TOKEN_EXPIRY_DT
					+ " = :" + AppConstants.TOKEN_EXPIRY_DT + ",acc." + AppConstants.IS_USED + " = :"
					+ AppConstants.IS_USED + " where up." + AppConstants.USER_NAME + " = :" + AppConstants.USER_NAME
					+ " and acc." + AppConstants.UUID + " = :" + AppConstants.UUID + " and  up."
					+ AppConstants.RECORD_ID + " = acc." + AppConstants.RECORD_ID;
			Map<String, Object> paramMap = new HashMap<String, Object>();
			paramMap.put(AppConstants.ACTIVATION_STATUS, user.getActiveStatus());
			...
			logger.error("ProfessionalDao.emailUpdateStatus() method thrown exception" + e.getMessage());
	...
	public long saveProfile(OspProfessionalBean professionalBean) throws OspDaoException {
		...
		try {
			...
			logger.error("ProfessionalDao.saveProfile() method thrown exception" + exp.getMessage());
	...
	public void approveProfile(OspProfessionalBean professionalBean) throws OspDaoException {
		...
		try {
			int count = 0;
			int initalStatusCode = configParamBean
					.getParameterByCodeName(AppConstants.PARAM_CODE_USER_STATUS, AppConstants.PARAM_NAME_INITIAL)
					.getParameterid();

			int actionStatusCode = 0;
			if (!StringUtils.isEmpty(professionalBean.getActionTaken())) {
				actionStatusCode = configParamBean
						.getParameterByCodeName(AppConstants.PARAM_CODE_USER_STATUS, professionalBean.getActionTaken())
						.getParameterid();
				...
				count = jdbcTemplate.update(updateStatus,
			...
			logger.error("ProfessionalDao.approveProfile() method thrown exception" + exp.getMessage());
			throw new OspDaoException(exp);
		} finally {
	...
	public void smsUpdateStatus(UserBean user, AccessToken access) throws OspDaoException {
		...
		try {
			String updateSmsStatusSql = " UPDATE OSP_ACCESS_TOKEN acc , OSP_USER_CREDENTIAL up " + "  SET " + " up."
					+ AppConstants.ACTIVATION_STATUS + "= :" + AppConstants.ACTIVATION_STATUS + " , up."
					+ AppConstants.SMS_VERIFIED + " = :" + AppConstants.SMS_VERIFIED + " , up." + AppConstants.LOGIN_TS
					+ " = :" + AppConstants.LOGIN_TS + " , acc." + AppConstants.TOKEN_EXPIRY_DT + " = :"
					+ AppConstants.TOKEN_EXPIRY_DT + " , acc." + AppConstants.IS_USED + " = :" + AppConstants.IS_USED
					+ " where up." + AppConstants.USER_NAME + " = :" + AppConstants.USER_NAME + " and acc."
					+ AppConstants.UUID + " = :" + AppConstants.UUID + " and  up." + AppConstants.RECORD_ID + " = acc."
					+ AppConstants.RECORD_ID;
			Map<String, Object> paramMap = new HashMap<String, Object>();
			paramMap.put(AppConstants.ACTIVATION_STATUS, user.getActiveStatus());
			paramMap.put(AppConstants.SMS_VERIFIED, user.getSmsVerfied());
			paramMap.put(AppConstants.LOGIN_TS, new Timestamp(new Date().getTime()));
			paramMap.put(AppConstants.TOKEN_EXPIRY_DT, access.getExpireTime());
			paramMap.put(AppConstants.IS_USED, user.getTokenIsUsed());
			paramMap.put(AppConstants.USER_NAME, user.getUserName());
			...
			logger.error("ProfessionalDao.smsUpdateStatus() method thrown exception" + e.getMessage());
			throw new OspDaoException(e);
  ...
  public void FUPUpdateStatus(UserBean user, AccessToken access) throws OspDaoException {
	...
	{
		logger.error("ProfessionalDao.FUPUpdateStatus() method thrown exception" + e.getMessage());
		throw new OspDaoException(e);
	} finally
	{
	...
	@Override
	public UserDTO getUserLinkValidCheckForEmail(UserBean user, AccessToken access) throws OspDaoException {
		logger.debug("Entrying ProfessionalDao >> getUserLinkValidCheckForEmail() method");
		try {
			String emailSql = "select * from OSP_USER_CREDENTIAL up , OSP_ACCESS_TOKEN " + " acc  where" + " up."
					+ AppConstants.USER_NAME + "= :user_name and " + " acc." + AppConstants.UUID + "=:UUID and"
					+ "  acc." + AppConstants.TOKEN_EXPIRY_DT + "> :EXPIRY_DT" + " and acc." + AppConstants.IS_USED
					+ "=" + AppConstants.IS_USED + " and  acc." + AppConstants.RECORD_ID + "= up."
					+ AppConstants.RECORD_ID;
			Map<String, Object> paramMap = new HashMap<String, Object>();
	...
	@Override
	public UserDTO getUserLinkValidCheckForFUP(UserBean user, AccessToken access) throws OspDaoException {
		logger.debug("Entrying ProfessionalDao >> getUserLinkValidCheckForFUP() method");
		try {
			String emailSql = "select * from OSP_USER_CREDENTIAL up , OSP_ACCESS_TOKEN " + " acc  where" + " up."
					+ AppConstants.USER_NAME + "= :user_name and " + " acc." + AppConstants.UUID + "=:UUID and"
					+ " and  acc." + AppConstants.TOKEN_EXPIRY_DT + "> :EXPIRY_DT" + " and acc." + AppConstants.IS_USED
					+ "=" + AppConstants.IS_USED + " and  acc." + AppConstants.USER_ID + "= up."
					+ AppConstants.RECORD_ID;
			Map<String, Object> paramMap = new HashMap<String, Object>();
			paramMap.put("user_name", user.getUserName());
	...
	@Override
	public UserDTO getUserLinkValidCheckForSms(UserBean user, AccessToken access) throws OspDaoException {
		logger.debug("Entrying ProfessionalDao >> getUserLinkValidCheckForSms() method");
		try {
			String emailSql = "select * from OSP_USER_CREDENTIAL up , OSP_ACCESS_TOKEN " + " acc  where" + " up."
					+ AppConstants.USER_NAME + "= :user_name and " + " acc." + AppConstants.UUID + "=:UUID "
					+ " and  acc." + AppConstants.TOKEN_EXPIRY_DT + "> :EXPIRY_DT" + " and acc." + AppConstants.IS_USED
					+ "=" + AppConstants.IS_USED + " and  acc." + AppConstants.RECORD_ID + "= up."
					+ AppConstants.RECORD_ID;
			Map<String, Object> paramMap = new HashMap<String, Object>();
	...
	public int getTokenCheck(UserBean user, AccessToken access) throws OspDaoException {
		...
		try {
			...
			String emailSql = "select count(up.RECORD_ID) from OSP_USER_CREDENTIAL up , OSP_ACCESS_TOKEN acc where"
					+ " up." + AppConstants.USER_NAME + "= :user_name and " + "( acc." + AppConstants.TOKEN_EXPIRY_DT
					+ "> :EXPIRY_DT" + " and acc." + AppConstants.IS_USED + "=:" + AppConstants.IS_USED + ")"
					+ " or acc." + AppConstants.IS_USED + "=:" + AppConstants.IS_USED + " and  acc."
					+ AppConstants.RECORD_ID + "= up." + AppConstants.RECORD_ID + " and " + "acc." + AppConstants.TYPE
					+ "=:" + AppConstants.TYPE;
			Map<String, Object> paramMap = new HashMap<String, Object>();
			paramMap.put("user_name", user.getUserName());
			paramMap.put("EXPIRY_DT", access.getExpireTime());
			...
			updateCount = namedJdbcTemplate.queryForInt(emailSql, paramMap);
		} catch (EmptyResultDataAccessException e) {
			logger.error("no record found . Explicitly throwing exception", e);
			throw new OspDaoException(e);
	...
	public void generateNewToken(UserBean user, int ExpireTime) throws OspDaoException {
		...
		try {
			String insertAccessToken = "INSERT INTO OSP_ACCESS_TOKEN VALUES " + "(:" + AppConstants.USER_ID + "," + ":"
					+ AppConstants.TYPE + "," + ":" + AppConstants.UUID + "," + ":" + AppConstants.TOKEN_EXPIRY_DT + ","
					+ ":" + AppConstants.IS_USED + "," + ":" + AppConstants.CREATED_TS + "," + ":"
					+ AppConstants.UPDATE_TS + "," + ":" + AppConstants.CREATED_BY + "," + ":" + AppConstants.UPDATE_BY
					+ ");";
			...
			accessTokenMapforEmail.put(AppConstants.TOKEN_EXPIRY_DT,
					new Timestamp(new Date().getTime() + (1 * (ExpireTime) * 60 * 60 * 1000)));
			...
			logger.error("ProfessionalDao.generateNewToken() method thrown exception" + e.getMessage());
			throw new OspDaoException(e);
		}finally{
	...
	public UserDTO checkForForgotPassword(UserBean user, AccessToken access) throws OspDaoException {
		...
		try {
			String emailSql = "select * from OSP_USER_CREDENTIAL up , OSP_ACCESS_TOKEN " + " acc  where" + " up."
					+ AppConstants.USER_NAME + "= :user_name and " + " acc." + AppConstants.UUID + "=:UUID and"
					+ " acc." + AppConstants.TOKEN_EXPIRY_DT + "> :EXPIRY_DT" + " and  acc." + AppConstants.RECORD_ID
					+ "= up." + AppConstants.RECORD_ID;
			Map<String, Object> paramMap = new HashMap<String, Object>();
			paramMap.put("user_name", user.getUserName());
			paramMap.put("UUID", user.getFupUUID());
			paramMap.put("EXPIRY_DT", access.getExpireTime());
  ...
  public void updatePassword(UserBean user) throws OspDaoException {
    ...
    namedJdbcTemplate.update(updatePassword, paramMap);
    	...
    	logger.error("ProfessionalDao.updatePassword() method thrown exception"+e.getMessage());
    	throw new OspDaoException(e);
	}
	...
	public long addProfile(OspProfessionalBean professionalBean) throws OspDaoException {
		...
		try {
			...
			logger.error("ProfessionalDao.addProfile() method thrown exception" + exp.getMessage());
			throw new OspDaoException(exp);
		}
	}
	...
	public List<OspProfessionalDTO> getAllProfessionalDetails() throws OspDaoException {
		...
		try {
			...
			logger.error("ProfessionalDao.getAllProfessionalDetails() method thrown exception" + exp.getMessage());
			throw new OspDaoException(exp);
	...
	public OspProfessionalDTO getProfessionalDetails(long profId) throws OspDaoException {
		...
		try {
			...
			logger.error("ProfessionalDao.getProfessionalDetails() method thrown exception" + exp.getMessage());
			throw new OspDaoException(exp);
		}
	...
	public List<OspProfSpecializationBean> getProfSpecializationList(long profId) throws OspDaoException {
		...
		String getSepecialzationSql = "select ops.PROF_SPEC_ID, ops.PROF_SPEC_NAME, ops.PROF_SPEC_DESC, ops.PROF_ID, "
				+ "ops.ACTIVE_STATUS, ops.CREATED_BY, ops.CREATED_TS"
				+ " from OSP_PROFESSIONAL op, OSP_PROF_SPECIALIZATIONS ops" + " where op.PROF_ID = ops.PROF_ID"
		...
		try {
			...
			logger.error("ProfessionalDao.getProfSpecializationList() method thrown exception" + exp.getMessage());
			throw new OspDaoException(exp);
	...
	public List<OspProfAcademicsBean> getProfQualificationList(long profId) throws OspDaoException {
		...
		String getAcademicsSql = "select opa.ACTIVE_STATUS, opa.PROF_ACDMC_DESC, "
				+ "opa.PROF_ACDMC_ID, opa.PROF_ACDMC_NAME, opa.PROF_ACDMC_PASS_YEAR, opa.PROF_ACDMC_UNIVERSITY"
				+ " from OSP_PROFESSIONAL op, OSP_PROF_ACADEMICS opa" + " where op.PROF_ID = opa.PROF_ID"
				+ " and op.PROF_ID = :prof_id ";
		...
		try {
			...
			logger.error("ProfessionalDao.getProfQualificationList() method thrown exception" + exp.getMessage());
			throw new OspDaoException(exp);
		}
	...
	public List<OspExperienceBean> getProfExperienceList(long profId) throws OspDaoException {
		...
		String getExperienceSql = "select ope.ACTIVE_STATUS, ope.PROF_EXP_BEGIN_DT, "
				+ "ope.PROF_EXP_DESC, ope.PROF_EXP_END_DT, ope.PROF_EXP_ID"
				+ " from OSP_PROFESSIONAL op, OSP_PROF_EXPERIENCE ope" + " where op.PROF_ID = ope.PROF_ID"
				+ " and op.PROF_ID = :prof_id ";
		Map<String, Object> paramMap = new HashMap<String, Object>();
		paramMap.put("prof_id", profId);
		try {
			experienceList = namedJdbcTemplate.query(getExperienceSql, paramMap, new RowMapper<OspExperienceBean>() {
				@Override
			...
			logger.error("ProfessionalDao.getProfExperienceList() method thrown exception" + exp.getMessage());
			throw new OspDaoException(exp);
		}
	...
	public UserDTO getTokenCheckforSms(UserBean user, AccessToken access) throws OspDaoException {
		try {
			...
			String emailSql = "select * from  OSP_USER_CREDENTIAL up ,OSP_ACCESS_TOKEN acc  where  up."
					+ AppConstants.USER_NAME + "= :user_name  " + " and  acc." + AppConstants.TOKEN_EXPIRY_DT
					+ "< :EXPIRY_DT" + " and  acc." + AppConstants.RECORD_ID + "= up." + AppConstants.RECORD_ID
	...
	public List<OspContactBean> fetchContactDetails(long profId) {
		...
		List<OspContactBean> contactDetailList = null;
		{
			...
			String getAddressSql = "select oc.CONTACT_ID,oc.CONTACT_TYPE,oc.CONTACT_PHONE,oc.CONTACT_EMAIL,oc.ACTIVE_STATUS from OSP_PROFESSIONAL op, OSP_CONTACT oc,OSP_PROF_CONTACT_MAP ocm  where ocm.CONTACT_ID = oc.CONTACT_ID and op.PROF_ID = ocm.PROF_ID"
			...
			contactDetailList = namedJdbcTemplate.query(getAddressSql, paramMap, new RowMapper<OspContactBean>() {
	...
	public List<OspAddressBean> fetchAddressDetails(long profId) {
		...
		List<OspAddressBean> addressDetailList = null;
		{
			...
			String getAddressSql = "select oad.ADDRESS_ID,oad.LOCATION_ID,oad.OTHER_AREA,oad.LINE_1,oad.LINE_2,oad.PIN_CODE,oad.ACTIVE_STATUS from OSP_PROFESSIONAL op,OSP_ADDRESS oad,OSP_PROF_ADDRESS_MAP oadmap  where oadmap.ADDRESS_ID = oad.ADDRESS_ID and op.PROF_ID = oadmap.PROF_ID"
					+ " and op.PROF_ID =:" + AppConstants.PROF_ID;

			HashMap<String, Long> paramMap = new HashMap<String, Long>();
			paramMap.put(AppConstants.PROF_ID, profId);

			addressDetailList = namedJdbcTemplate.query(getAddressSql, paramMap, new RowMapper<OspAddressBean>() {
	...
	public List<OspProfessionalDTO> fetchApprovalProfList() throws OspDaoException {
		...
		try {
			 ...
			 * " where op.PROF_ID = ocm.PROF_ID" +
			 * " and ocm.CONTACT_ID = oc.CONTACT_ID" +
			 * " and op.PROF_ID = oadmap.PROF_ID" +
			 * " and oadmap.ADDRESS_ID = oad.ADDRESS_ID" +
			 * " and op.PROF_ID = ops.PROF_ID" + " and op.PROF_ID = opa.PROF_ID"
			 * + " and op.PROF_ID = ope.PROF_ID and op.STATUS=:STATUS";
			 */
			...
			professionalDetailList = namedJdbcTemplate.query(getProSql, paramMap, new RowMapper<OspProfessionalDTO>() {
				@Override
				public OspProfessionalDTO mapRow(ResultSet rs, int rowNum) throws SQLException {
					OspProfessionalDTO prof = new OspProfessionalDTO();
			...
			logger.error("ProfessionalDao.fetchApprovalProfList() method thrown exception" + exp.getMessage());
			throw new OspDaoException(exp);
	...
	@Override
	public void saveProfAcheivements(final OspProfessionalBean professionalBean) throws OspDaoException {
		final List<OspProfAcheivementBean> acheivements = professionalBean.getAcheivements();
		if (null != acheivements && !acheivements.isEmpty()) {
			try {
				jdbcTemplate.batchUpdate(SQL_INSERT_OSP_PROF_ACHIEVEMENT, new BatchPreparedStatementSetter() {
					...
					public void setValues(PreparedStatement ps, int index) throws SQLException {
						...
						ps.setTimestamp(AppConstants.INT_EIGHT, new java.sql.Timestamp(new Date().getTime()));
				...
				logger.error("ProfessionalDao.saveProfAcheivements() method thrown exception" + exp.getMessage());
				throw new OspDaoException(exp);
			}
	...
	@Override
	public void saveProfRegMemNos(final OspProfessionalBean professionalBean) throws OspDaoException {
		final List<OspProfRegMemNoBean> regMemNos = professionalBean.getRegisteredMemNos();
		if (null != regMemNos && !regMemNos.isEmpty()) {
			try {
				jdbcTemplate.batchUpdate(SQL_INSERT_OSP_PROF_REG_MEM_NO, new BatchPreparedStatementSetter() {
				...
				logger.error("ProfessionalDao.saveProfRegMemNos() method thrown exception" + exp.getMessage());
				throw new OspDaoException(exp);
			}
	...
	@Override
	public void saveProfPublication(final OspProfessionalBean professionalBean) throws OspDaoException {
			...
			for (final OspProfPublication publication : lstProfPublications) {
				...
				jdbcTemplate.update(new PreparedStatementCreator() {
					...
					public PreparedStatement createPreparedStatement(Connection con) throws SQLException {
						PreparedStatement ps = con.prepareStatement(SQL_INSERT_OSP_PROF_PUBLICATION,
								new String[] { "PROF_PUB_ID" });
						ps.setNull(AppConstants.INT_ONE, Types.BIGINT);
				...
				if (null != lstPubDesc && !lstPubDesc.isEmpty()) {
					jdbcTemplate.batchUpdate(SQL_INSERT_OSP_PUBLICATION_DESC, new BatchPreparedStatementSetter() {
						...
						public void setValues(PreparedStatement ps, int index) throws SQLException {
							...
							ps.setTimestamp(AppConstants.INT_FIVE, new java.sql.Timestamp(new Date().getTime()));
	...
	@Override
	public void saveProfPresentation(final OspProfessionalBean professionalBean) throws OspDaoException {
		final List<OspProfPresentation> lstProfPresentations = professionalBean.getLstProfPresentation();
		if (null != lstProfPresentations && !lstProfPresentations.isEmpty()) {
			for (final OspProfPresentation presentaion : lstProfPresentations) {
				...
				jdbcTemplate.update(new PreparedStatementCreator() {
					...
					@Override
					public PreparedStatement createPreparedStatement(Connection con) throws SQLException {
						PreparedStatement ps = con.prepareStatement(SQL_INSERT_OSP_PROF_PRESENTATION,
								new String[] { "PROF_PRSN_ID" });
						ps.setNull(AppConstants.INT_ONE, Types.BIGINT);
				...
				if (null != lstPresentation && !lstPresentation.isEmpty()) {
					jdbcTemplate.batchUpdate(SQL_INSERT_OSP_PRESENTATION_DESC, new BatchPreparedStatementSetter() {
	...
	public void updateTokenStatus(UserBean user, AccessToken access) throws OspDaoException {
		...
		String updateEmailStatusSql = " UPDATE OSP_ACCESS_TOKEN acc , OSP_USER_CREDENTIAL up " + "  SET " + " up."
				+ AppConstants.LOGIN_TS + " = :" + AppConstants.LOGIN_TS + " , acc." + AppConstants.TOKEN_EXPIRY_DT
				+ " = :" + AppConstants.TOKEN_EXPIRY_DT + ",acc." + AppConstants.IS_USED + " = :" + AppConstants.IS_USED
				+ " where up." + AppConstants.USER_NAME + " = :" + AppConstants.USER_NAME + " and "
				+ AppConstants.TOKEN_EXPIRY_DT + "< :EXPIRY_DT and " + "acc." + AppConstants.IS_USED + " = :"
				+ AppConstants.IS_USED + " and acc." + AppConstants.TYPE + "=:" + AppConstants.TYPE + " and  up."
				+ AppConstants.RECORD_ID + " = acc." + AppConstants.RECORD_ID;
		Map<String, Object> paramMap = new HashMap<String, Object>();
		paramMap.put(AppConstants.LOGIN_TS, new Timestamp(new Date().getTime()));
		paramMap.put(AppConstants.TOKEN_EXPIRY_DT, access.getExpireTime());
