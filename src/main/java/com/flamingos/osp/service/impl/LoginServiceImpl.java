...
public class LoginServiceImpl implements LoginService {
    ...
    public UserDTO login(UserBean loginBean) throws OSPBusinessException {
        ...
        try {
            ...
            throw new OSPBusinessException(AppConstants.LOGIN_MODULE, AppConstants.LOGIN_EXCEPTION_ERRCODE, AppConstants.LOGIN_EXCEPTION_ERRDESC, exp);
        } finally {
            logger.debug("Entrying LoginService << login() method");
        }
    }
    ...
    public String sendLinkForForgotPassword(UserBean userBean, HttpServletRequest request)
        ...
        emailService.sendMail("FUP_VERIFY", userBean.getEmail(), linkTobeSend,"", "Forgot Password Link", userBean.getUserName());
